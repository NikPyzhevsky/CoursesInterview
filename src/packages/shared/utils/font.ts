...
const sourceBodyFont = Platform.OS === 'ios' ? 'Inter' : 'Inter';
...
export const FONT_VARIANTS = {
  ...
  S: getFontStyleByWeight('400', 'Inter', 14, 20),
  'S.Bold': getFontStyleByWeight('700', 'Inter', 14, 20),
  'S.SemiBold': getFontStyleByWeight('600', 'Inter', 14, 20),
  'S.ExtraBold': getFontStyleByWeight('800', 'Inter', 14, 20),
